...
public class MethdExample3 {

	/*
	 * 반환 유형(return type)
	 * 
	 * 1. 변환값은 메서드를 호출한 곳을 전달해주는 return 구문 우측 값을 의미합니다.
	 * 2. 매개변수는 여러 개를 입력받을 수 있지만 반환값은 오로지 하나여야 합니다.
	 * 3. return 키워드를 사용해 반환 값을 지정할 수 있습니다.
	 * 4. 전달할 변환값의 자료형을 변환 유형이라고 합니다.
	 ...
	 *    분기가 아닌 return 구문 하단에서 추가 코드를 작성하면 경고가 뜹니다.
	 */
	...
	public static void main(String[] args) {
		...
		// 리턴 자료가 있는 함수는 매직넘버 대신 사용할 수 있다.
